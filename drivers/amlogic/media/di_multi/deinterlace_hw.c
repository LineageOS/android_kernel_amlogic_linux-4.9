...
{
	ops_ext()->switch_vpu_mem_pd_vmod(VPU_VIU_VD1,
					  enable ? true : false);
	ops_ext()->switch_vpu_mem_pd_vmod(VPU_DI_POST,
					  enable ? true : false);
}
...
{
	if (on)
		ops_ext()->switch_vpu_mem_pd_vmod(VPU_VIU_VD1, true);
	else
		ops_ext()->switch_vpu_mem_pd_vmod(VPU_VIU_VD1, false);
}
